...
describe("MapLayout", () => {
  ...
  it("sets and removes --app-min-width on mount lifecycle", () => {
    ...
    const { unmount } = render(
      <MapLayout legendLayers={legendLayers} marks={marks} towns={[]} />
    );
  ...
  it("renders MapLegendColumn before MapStage", async () => {
    render(<MapLayout legendLayers={legendLayers} marks={marks} towns={[]} />);
  ...
  it("shows historical loading overlay when towns are loading", () => {
    render(
      <MapLayout
