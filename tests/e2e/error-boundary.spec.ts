...
test.describe("Error Boundary", () => {
  ...
  test("should show Reset and Reload Page buttons when error occurs", async ({
    page,
  }) => {
    await page.goto("/?testError=true");
  ...
  test("should handle Reset button click to reset error state", async ({
    page,
  }) => {
    await page.goto("/?testError=true");
    ...
    // so reset keeps the boundary visible while confirming the action is wired.
